...
- Applied the progress-preservation function/trigger, restricted profile updates to email, and removed public execution rights from the internal `handle_new_user` security-definer function. The migration is replay-safe for the trigger already applied through the dashboard.
